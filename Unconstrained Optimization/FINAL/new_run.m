...
%make matrix for errors of methods
M = zeros(5,10);
z=max_iters;
...
figure;
plot(iter,err1,iter,1./(iter.^s));
legend('abs error','1/k^s');
...
figure;
plot(iters2,err5,iters2,1./iters2);
